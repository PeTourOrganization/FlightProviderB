 ...
 *                 <sequence>
 *                   <element ref="{http://www.travelport.com/schema/air_v54_0}FlightTimeDetail" maxOccurs="999"/>
 *                 </sequence>
 *               </restriction>
 *             </complexContent>
 *           </complexType>
    ...
    extends BaseSearchRsp
{
    ...
    public static class FlightTimeTableList {
         ...
         * This is why there is not a <CODE>set</CODE> method for the flightTimeDetail property.</p>
         * 
         * <p>
         ...
         * 
         * @return
         *     The value of the flightTimeDetail property.
         */
        public List<FlightTimeDetail> getFlightTimeDetail() {
            if (flightTimeDetail == null) {
                flightTimeDetail = new ArrayList<>();
            }
