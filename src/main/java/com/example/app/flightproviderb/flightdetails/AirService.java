...
public class AirService extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.travelport.com/service/air_v54_0", "AirService");
    public static final QName AirRefundTicketPort = new QName("http://www.travelport.com/service/air_v54_0", "AirRefundTicketPort");
    public static final QName AirUpsellSearchPort = new QName("http://www.travelport.com/service/air_v54_0", "AirUpsellSearchPort");
    public static final QName AirScheduleSearchPort = new QName("http://www.travelport.com/service/air_v54_0", "AirScheduleSearchPort");
    public static final QName AirMerchandisingOfferAvailabilityPort = new QName("http://www.travelport.com/service/air_v54_0", "AirMerchandisingOfferAvailabilityPort");
    public static final QName AirFareRulesPort = new QName("http://www.travelport.com/service/air_v54_0", "AirFareRulesPort");
    public static final QName AirRetrieveDocumentBindingPort = new QName("http://www.travelport.com/service/air_v54_0", "AirRetrieveDocumentBindingPort");
    public static final QName AirAvailabilitySearchPort = new QName("http://www.travelport.com/service/air_v54_0", "AirAvailabilitySearchPort");
    public static final QName EMDIssuancePort = new QName("http://www.travelport.com/service/air_v54_0", "EMDIssuancePort");
    public static final QName FlightTimeTablePort = new QName("http://www.travelport.com/service/air_v54_0", "FlightTimeTablePort");
    public static final QName EMDRetrievePort = new QName("http://www.travelport.com/service/air_v54_0", "EMDRetrievePort");
    public static final QName AirExchangeMultiQuotePort = new QName("http://www.travelport.com/service/air_v54_0", "AirExchangeMultiQuotePort");
    public static final QName AirExchangeProcessPort = new QName("http://www.travelport.com/service/air_v54_0", "AirExchangeProcessPort");
    public static final QName AirExchangeTicketingPort = new QName("http://www.travelport.com/service/air_v54_0", "AirExchangeTicketingPort");
    public static final QName AirExchangeEligibilityPort = new QName("http://www.travelport.com/service/air_v54_0", "AirExchangeEligibilityPort");
    public static final QName AirRepriceSearchPort = new QName("http://www.travelport.com/service/air_v54_0", "AirRepriceSearchPort");
    public static final QName AirExchangeQuotePort = new QName("http://www.travelport.com/service/air_v54_0", "AirExchangeQuotePort");
    public static final QName AirRefundQuotePort = new QName("http://www.travelport.com/service/air_v54_0", "AirRefundQuotePort");
    public static final QName AirTicketingPort = new QName("http://www.travelport.com/service/air_v54_0", "AirTicketingPort");
    public static final QName AirLowFareSearchPort = new QName("http://www.travelport.com/service/air_v54_0", "AirLowFareSearchPort");
    public static final QName AirFareDisplayPort = new QName("http://www.travelport.com/service/air_v54_0", "AirFareDisplayPort");
    public static final QName SeatMapPort = new QName("http://www.travelport.com/service/air_v54_0", "SeatMapPort");
    public static final QName AirPrePayPort = new QName("http://www.travelport.com/service/air_v54_0", "AirPrePayPort");
    public static final QName AirPricePort = new QName("http://www.travelport.com/service/air_v54_0", "AirPricePort");
    public static final QName AirMerchandisingDetailsPort = new QName("http://www.travelport.com/service/air_v54_0", "AirMerchandisingDetailsPort");
    public static final QName AirVoidDocumentPort = new QName("http://www.travelport.com/service/air_v54_0", "AirVoidDocumentPort");
    static {
        URL url = AirService.class.getClassLoader().getResource("/air_v54_0/Air.wsdl");
        if (url == null) {
            url = AirService.class.getClassLoader().getResource("air_v54_0/Air.wsdl");
        }
        if (url == null) {
