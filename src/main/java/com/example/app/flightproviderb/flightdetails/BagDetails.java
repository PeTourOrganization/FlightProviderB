 ...
 *       <sequence>
 *         <element ref="{http://www.travelport.com/schema/air_v54_0}BaggageRestriction" maxOccurs="999" minOccurs="0"/>
 *         <element ref="{http://www.travelport.com/schema/air_v54_0}AvailableDiscount" maxOccurs="999" minOccurs="0"/>
 *       </sequence>
...
public class BagDetails {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the availableDiscount property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
